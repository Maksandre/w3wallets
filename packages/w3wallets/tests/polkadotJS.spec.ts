...
test("Can sign and send a native token transfer", async ({page, polkadotJS}) => {
  await page.getByPlaceholder("Recipient").fill("5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty")
